                            ...
                            @foreach($repository->releases as $release)
                                <tr>
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        ...
                                        <button type="button" wire:click="$emit('modal.open', 'assets-show', @js(['releaseId' => $release->id]))" class="inline-flex items-center rounded border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">View Assets</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
